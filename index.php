				...
				<div id="myCarousel" class="carousel slide onDesktop" data-ride="carousel">
				  <!-- Wrapper for slides -->
					<div class="carousel-inner slider" role="listbox">
						<?php
						$result = $User->query("SELECT `sliderImage`,`sliderImageName`, `sliderHeading`, `sliderText`, `buttonOne`, `buttonTwo` FROM `tblSlider`");
						$counter = 1;
						if(is_array($result) && count($result) > 0){
							...
							$buttonTwo = explode("+", trim($slider['buttonTwo']));
								$css_type_1 = '';
								$css_type_2 = '';
							if($slider['sliderImageName'] == 'siteregisterslider.png'){
								$css_type_1 = 'cover-1';
								$css_type_2 ='cover-2';
							}
						?>
						...
						<div class="item<?php if($counter <= 1){echo " active"; } ?>">
							...
							<div class="<?php echo $css_type_1?> carousel-caption ask-carousel-caption">
								<h3 class="<?php echo $css_type_2?> hidden-xs"><?php echo $slider['sliderHeading']; ?></h3>
									...
									<div class="media">
									  	...
									  	<div class="media-body">
									    	...
									    	<div class="rating font16">
												<?php
												echo '<p class="text-white" style="margin-bottom:2px;">'. $value['extraText'] .'</p>';
												?>

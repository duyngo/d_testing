				...
				<div class="content no-padding timeline">
					...
					<div class="tl-post">
						...
						<div class="w3-bar w3-black">
							<a href="javascript:void(0);" class="w3-bar-item w3-button" onclick="openCity('Resolved')">Resolved</a>
							<a href="javascript:void(0);" class="w3-bar-item w3-button" onclick="openCity('Solved')">Solved</a>
							<a href="javascript:void(0);" class="w3-bar-item w3-button" onclick="openCity('Pending')">Pending</a>
						</div>

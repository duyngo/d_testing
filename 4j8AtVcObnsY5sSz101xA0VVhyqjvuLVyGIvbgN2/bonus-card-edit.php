		...
		<div class="panel panel-default bt-panel" style="box-shadow:none;">
			...
			if(isset($_GET['edit']) && trim($_GET['edit'])){
				...
				if($result && is_array($result) && count($result) > 0){
					...
					$editValue['wageringRequirementsMinigame'] = $result[0]['wageringRequirementsMinigame'];
			...
			?>
				<div class="content">
					...
					<div class="field-wrap">
						<div class="field-wrap-half form-group">
							<select name="bonustype" id="bonustype">
								...
								<option <?php if ($editValue['bonustype'] == '신규 첫충 보너스' ) echo 'selected' ; ?> value="신규 첫충 보너스">신규 첫충 보너스</option>
								<option <?php if ($editValue['bonustype'] == '첫충전 보너스' ) echo 'selected' ; ?> value="첫충전 보너스">첫충전 보너스</option>
								<option <?php if ($editValue['bonustype'] == '매번 충전 보너스' ) echo 'selected' ; ?> value="매번 충전 보너스">매번 충전 보너스</option>
								<option <?php if ($editValue['bonustype'] == '롤링 보너스' ) echo 'selected' ; ?> value="롤링 보너스">롤링 보너스</option>
								<option <?php if ($editValue['bonustype'] == '꽁머니 보너스' ) echo 'selected' ; ?> value="꽁머니 보너스">꽁머니 보너스</option>
								<option <?php if ($editValue['bonustype'] == '다폴더 보너스' ) echo 'selected' ; ?> value="다폴더 보너스">다폴더 보너스</option>
								<option <?php if ($editValue['bonustype'] == '낙첨금 보너스' ) echo 'selected' ; ?> value="낙첨금 보너스">낙첨금 보너스</option>
								<option <?php if ($editValue['bonustype'] == '기타 보너스' ) echo 'selected' ; ?> value="기타 보너스">기타 보너스</option>
							</select>
						</div>
						<div class="field-wrap-half form-group">
					...
					<div class="field-wrap">
						<div class="field-wrap-half form-group">
							<input type="text" value="<?php echo $editValue['wageringRequirements'];?>" name="wageringRequirements" placeholder="이용 조건 (스포츠)" />
						</div>
						
						<div class="field-wrap-half form-group">
							<input type="text" value="<?php echo $editValue['wageringRequirementsMinigame'];?>" name="wageringRequirementsMinigame" placeholder="이용 조건 (미니게임)" />
						</div>
					</div>
					<div class="field-wrap">
						<div class="field-wrap-half form-group">
